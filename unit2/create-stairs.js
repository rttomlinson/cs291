...
function createStairs() {
	...
	stepMesh.position.z = i * (horizontalStepDepth - stepHalfThickness * 2);			// centered at origin
	scene.add( stepMesh );
	...
	stepMesh.position.y = verticalStepHeight + stepHalfThickness + ( i * (verticalStepHeight + stepThickness));
	// Push step forward by half the depth, minus half the vertical step's thickness
	stepMesh.position.z = (horizontalStepDepth/2 - stepHalfThickness) + (i * (2 * (horizontalStepDepth/2 - stepHalfThickness)));
	scene.add( stepMesh );
	}
